...
typedef enum _ACKHardwarePin_t
{
    ...
    ,ACK_HW_PIN_MODULE_POWER_SAVING_LOCK
#endif
...
// // Changes the state of a analog GPIO pin.
// void ACKPlatform_WriteAnalogPin(ACKHardwarePin_t pin, bool state);

// // Reads the state of a analog GPIO pin.
